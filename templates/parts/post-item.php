...
?>
        <div class="relevantly-related__item">
            <?php if ( has_post_thumbnail( $post_obj->ID ) ): ?>
                <div class="relevantly-related__item-img">
                    <?php print get_the_post_thumbnail( $post_obj->ID ); ?>
                </div>
            <?php endif; ?>

            <?php if ( ! empty( $title ) ): ?>
                <h3 class="relevantly-related__item-title">
            ...
            <?php if ( ! empty( $excerpt ) ): ?>
                <p class="relevantly-related__item-content"><?php echo esc_html( $excerpt ); ?></p>
            <?php endif; ?>
        </div>
    <?php endif;
endif;